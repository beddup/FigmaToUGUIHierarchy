...
run the python script `.agents/skills/prefab_hierarchy_creation_workflow/scripts/combine_hierarchy.py` from the project root to combine multiple prefab hierarchy files:

```bash
python3 .agents/skills/prefab_hierarchy_creation_workflow/scripts/combine_hierarchy.py \
